...
copyright = f'2022-{date.today().year}, {{ cookiecutter.owner_name }}'  # pylint: disable=redefined-builtin
author = '{{ cookiecutter.owner_name }}'
root_package = '{{ cookiecutter.project_slug }}'
version = {{ cookiecutter.project_slug }}.__version__  # type: ignore[reportUndefinedVariable]
release = version
...
html_theme_options = {
    'repository_url': 'https://github.com/mdt-neurovascular/{{ cookiecutter.project_slug }}',
